...
tags: [customer, renewal, hubspot]
status: archived
---

# HubSpot deal export — Northstar renewal

Verbatim export from HubSpot (the pipeline source of truth) for the
[[records/companies/northstar]] renewal. The records under `records/`
are synced from exports like this one; HubSpot is never written back to.
