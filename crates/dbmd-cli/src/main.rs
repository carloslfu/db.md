...
fn dispatch(ctx: &Context, command: &Command) -> CliResult {
    match command {
        ...
        Command::Show(args) => cmd::show::run(ctx, args),
        Command::Sections(args) => cmd::sections::run(ctx, args),
        Command::Schema(args) => cmd::schema::run(ctx, args),
        ...
        Command::Body(args) => cmd::body::run(ctx, args),
        Command::Section(args) => cmd::section::run(ctx, args),
        ...
        Command::Rm(args) => cmd::rm::run(ctx, args),
